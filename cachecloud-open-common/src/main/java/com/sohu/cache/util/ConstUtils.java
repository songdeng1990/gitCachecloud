...
public class ConstUtils {
     ...
     * redis安装脚本名称
     */
    public static final String REDIS_SCRIPT_NAME = "cachecloud-init.sh";
    public static final String REDIS_SCRIPT_PATH = "cachecloud-init.sh";
    //public static final String REDIS_SCRIPT_PATH = "/opt/cachecloud-web/cachecloud-init.sh";
    
    /**
     * redis监控重启脚本名称
     */
    public static final String REDIS_MONITOR_SCRIPT = "redis_monitor.sh";
    ...
    public static double DEFAULT_DISK_THRESHOLD = 80;
    public static double DISK_THRESHOLD = DEFAULT_DISK_THRESHOLD;

    public static double QUEUE_SIZE_ALARM = 80.0;
     ...
     */
    public static String DEFAULT_REDIS_MIGRATE_TOOL_HOME = "/opt/redis/redis-migrate-tool/";
     ...
     */
    public static String DEFAULT_CACHECLOUD_BASE_DIR = "/opt/redis";
    ...
    /**
     * 添加机器信息时，需要指定一个默认机房信息。
     */
    public static String DEFAULT_IDC_ID = "-1";
    public static String DEFAULT_IDC_NAME = "";
...
/*    public static final String UNION_CACHE_ADD_URL = "http://bjff-consul-api.jpushoa.com/cache/group/addCacheResourceGroup";
    ...
    public static String UNION_CACHE_CHECK_URL = "/cache/group/queryCacheResourceGroupById";
    public static String UNION_CACHE_DELETE_URL = "/cache/group/deleteCacheResourceGroupById";
    public static String UNION_CACHE_USER_URL = "/cache/group/synAuthInfoById";
    
    public static String DEFAULT_AOF_TIME = "02:00-02:09";
    public static String AOF_TIME = DEFAULT_AOF_TIME;
    public static String DEFAULT_DISALBE_ALARM_TIME = "";
    public static String DISALBE_ALARM_TIME = DEFAULT_DISALBE_ALARM_TIME;
    public static int DEFAULT_AOF_DISKUSAGE_THRESHOLD = 60;
    public static int AOF_DISKUSAGE_THRESHOLD = DEFAULT_AOF_DISKUSAGE_THRESHOLD;
    
    public static int DEFAULT_RESHARD_THREAD_NUM = 50;
    public static int RESHARD_THREAD_NUM = DEFAULT_RESHARD_THREAD_NUM;
    
    /*
     * 默认redi备份天数
     */
    public static int DEFALT_BAKCUP_DAYS= 3;
    public static String BAKCUP_DIR = CACHECLOUD_BASE_DIR + "/backup";
    public static int COPY_SPEED_LIMIT = 20000;
    ...
    public static String SYNC_TO_JCACHE= DEFAULT_SYNC_TO_UNION_CACHE;
    public static int DEFAULT_SQL_COMMIT_LIMIT = 3000;
    public static int SQL_COMMIT_LIMIT = DEFAULT_SQL_COMMIT_LIMIT;
    
    public static int REDIS_TYPE = 1;
    public static int COUCHBASE_TYPE = 2;
    
    public static int CLUSTER_TYPE = 3;
    public static int SINGLE_TYPE= 2;
    
    public static String DEFAULT_BAKCUP_CHECK_TIME = "14:00-14:39";
    public static String BACKUP_CHECK_TIME = DEFAULT_BAKCUP_CHECK_TIME;
}
