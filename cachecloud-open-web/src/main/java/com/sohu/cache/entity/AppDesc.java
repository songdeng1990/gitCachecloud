...
public class AppDesc implements Serializable {
    ...
    /**
     * 一个内部redis proxy代理系统,为空则无需使用该代理，如需使用请填写代理地址，格式http://ip:port
     */
    private String jcacheUrl;
	...
	public String getJcacheUrl() {
		return jcacheUrl;
	}

	public void setJcacheUrl(String jcacheUrl) {
		this.jcacheUrl = jcacheUrl;
	}
