...
public interface RedisCenter {
     ...
     * @return
     */
    public void collectRedisInfo(long appId, long collectTime, String host,
            int port);
     ...
     * @return
     */
    public void collectRedisSlowLog(long appId, long collectTime, String host,
            int port);
	...
	Boolean hasSlaves(String ip, int port);
     ...
     * @return
     */
	Map<RedisConstant, Map<String, Object>> getInfoStats(String host, int port);

	Jedis getAuthJedis(String ip, int port);

	Jedis getAuthJedis(String ip, int port, int timeout);
