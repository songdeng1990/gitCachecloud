...
public class SSHTemplate {
	...
	private static final int OP_TIMEOUT = 1800000;
	...
	private static SSHTemplate self;
    ...
    public class SSHSession{
    	...
    	public Result scpToDir(String localFile, String remoteTargetDirectory, String mode) {
    		return scp(new String[] { localFile }, null, remoteTargetDirectory, "0744");
    	}
    	...
    	public Result scpToFile(String localFile, String remoteFile, String remoteTargetDirectory, String mode) {
    		return scp(new String[] { localFile }, new String[] { remoteFile }, remoteTargetDirectory, mode);
    	}
    }
