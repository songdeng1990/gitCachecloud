...
public class SimpleChartData {
	 ...
	 * AppCommandStats转换为SimpleChartData
	 *
	 * @param groupCommandStats
	 * @return
	 * @throws ParseException
	 */
	public static SimpleChartData getFromGroupCommandStats(
			GroupCommandStats groupCommandStats, Integer addDay) throws ParseException {
		SimpleChartData chartData = new SimpleChartData();
		long collectTime = groupCommandStats.getCollectTime();
		String commandName = groupCommandStats.getCommandName();
	 ...
	 * @throws ParseException
	 */
	public static SimpleChartData getFromGroupStats(GroupStats groupStats, String statName) throws ParseException {
		SimpleChartData chartData = new SimpleChartData();
		long collectTime = groupStats.getCollectTime();
		long count = 0;
		if ("hits".equals(statName)) {
