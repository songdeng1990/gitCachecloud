...
public interface AppService {
     ...
     * @return
     */
    SuccessEnum changeAppAlertConfig(long appId, int memAlertValue, int clientConnAlertValue, int openAlarm, AppUser appUser);
    ...
    List<BusinessGroup> getAllBusinessGroup();

    String getGroupName(long businessGroupId);

	List<String> getAppBackupList(Long appId);

	boolean restoreBackup(Long appId, String date);
	
	boolean setPwd(Long appId, String pwd);
}
