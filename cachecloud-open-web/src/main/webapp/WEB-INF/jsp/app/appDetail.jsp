					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-body">
								...
								<div class="form-group">
									<label class="control-label col-md-3">应用是否告警:</label>
									<div class="col-md-7">
										<select name="openAlarm" class="form-control" id="openAlarm">
											<option value="1" <c:if test="${appDetail.appDesc.openAlarm == '1'}">selected</c:if>>
												是
											</option>
											<option value="0" <c:if test="${appDetail.appDesc.openAlarm == '0'}">selected</c:if>>
												否
											</option>
										</select>
									</div>
