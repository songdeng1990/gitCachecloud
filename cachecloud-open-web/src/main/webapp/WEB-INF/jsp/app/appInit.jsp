									...
									<form action="/admin/app/add.do" method="post"
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<select id="businessGroupId" name="businessGroupId" class="form-control">
														<c:forEach var="group" items="${appGroupList}">
															<option value="${group.businessGroupId}">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<input type="text" name="jcacheUrl" id="jcacheUrl" placeholder="http://ip:port"
														class="form-control" />
													<span class="help-block">
														请严格按照http://ip:port的格式填写，如果应用与jcache无关则请保持为空。
													</span>
												</div>
											</div>
