                        ...
                        <tr>
                            ...
                            <td>
                            	<c:choose>
                            		...
                            		<c:when test="${processMap.value.type == 2}">迁移节点</c:when>
                            	</c:choose>
                            </td>
...
<script type="text/javascript">
	$(function(){
		function show(){
		   ...
		   var url = "/manage/app/showReshardProcess.json?appId=" + appId;
		   $.get(url, function(data) {
  				...
  				for (var i = 0; i < length; i++) {
  					...
  					document.getElementById("reshardSlot" + hostPort).innerHTML = reshardSlot;
  					document.getElementById("totalSlot" + hostPort).innerHTML = totalSlot;
  					document.getElementById("reshardSlotProgress" + hostPort).style.width = (reshardSlot * 100 / totalSlot ) + "%";
  					document.getElementById("statusDesc" + hostPort).innerHTML = statusDesc;
  				}
  			});
		}
