...
<div class="row">
    <div class="page-header">
        <h4>
        	...
        	<button type="button" class="btn btn-small btn-primary" data-toggle="modal" onclick="batchShutdownInstance()">下线所有实例</button>
        	<button type="button" class="btn btn-small btn-primary" data-toggle="modal" onclick="batchStartInstance()">上线所有实例</button>
        	<c:choose>
	                ...
	                <tr>
	                    ...
	                    <td>
	                    	<div>
                                <c:choose>
                                   <c:when test="${instance.status ==2}">
                                    ...
                                    <c:when test="${instance.status ==0}">
                                        ...
                                        <button type="button" class="btn btn-small btn-danger" onclick="shutdownInstance('${instance.id}','${appDesc.needPersistence}')">
                                            	下线实例
                                        </button>
                                        <c:choose>
                                ...
                                <button type="button" class="btn btn-small btn-danger" onclick="deleteInstance('${instance.id}','${appDesc.needPersistence}')">
                                            	删除实例
                                </button>
	                    	</div>
	                    </td>
